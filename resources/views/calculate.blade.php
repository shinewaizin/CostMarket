                ...
                <div class="col-10">
                    <div class="card mt-5 bcolor border-0 cardshadow">
                        <div class="card-header bg-warning">
                            ...
                            <div class="w-100 d-flex justify-content-center"> <h3 class="text-dark text-uppercase tshadow"> Calculate Your Market Cost</h3> </div>
                                ...
                                <div class="col-5 border-start border-info ">
                                    ...
                                    <div class="card ibcolor">
                                        ...
                                        <div class="card-body cardbody">
                                            ...
                                            <div class="w-100 d-flex justify-content-center"><h5 class="text-dark fw-bold">Total Bill</h5></div>
