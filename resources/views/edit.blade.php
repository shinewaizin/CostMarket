                    ...
                    <div class="card mt-5 bcolor border-0 cardshadow">
                        ...
                        <div class="card-body cardbody">
                            ...
                            {{-- Calculate Tebt --}}
                                ...
                                <div class="col-7">
                                    <form action="{{ route('update',$calculate->id) }}" method="post">
                                        ...
                                        <div class="row mt-4">
                                            <div class="col-6">
                                                ...
                                                <input required type="number" value="{{ $calculate->TotalM }}" name="memberTotalMoney" class="form-control ibcolor " id="TotalM" placeholder="...MMK">
                                            </div>

                                            <div class="col-6">
                                                <label for="CurrentTotalM" class="mcolor">Current Total M</label>
                                                <input required type="number" value="{{ $calculate->CurrentM }}" name="currentTotalMoney" class="form-control ibcolor" id="CurrentTotalM" placeholder="...MMK">
                                            </div>
                                        </div>
                                        ...
                                        <div class="my-5 row">
                                            <div class="col-8">
                                                ...
                                                <input required type="text" value="{{ $calculate->FirstTitle }}" name="firstTitle" class="form-control ibcolor" id="FirstTitle" placeholder="....Goods">
                                            </div>

                                            <div class="col-4">
                                                <label for="FirstCost" class="mcolor">Cost M</label>
                                                <input required type="number" value="{{ $calculate->FirstCost }}" name="firstCost" class="form-control ibcolor" id="FirstCost" placeholder="...MMK">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-8">
                                                ...
                                                <input required type="text" value="{{ $calculate->SecondTitle }}" name="secondTitle" class="form-control ibcolor" id="secondTitle" placeholder="....Goods">
                                            </div>

                                            <div class="col-4">
                                                <label for="SecondCost" class="mcolor">Cost M</label>
                                                <input required type="number" value="{{ $calculate->SecondCost }}" name="secondCost" class="form-control ibcolor" id="SecondCost" placeholder="...MMK">
                                            </div>
                                        </div>

                                        <button class="btn btn-primary mt-5 ibcolor text-dark fw-bold">Update Calculated</button>
                                    </form>
                                </div>
                                    ...
                                    <div class="card ibcolor">
                                        ...
                                        <div class="card-body cardbody">
                                            ...
                                            <div class=" d-flex justify-content-between align-items-center mt-4">
                                                ...
                                                <h6 class="text-dark" id="totalM">{{ $calculate->TotalM }} MMK</h6>
                                            </div>

                                            <div class=" d-flex justify-content-between align-items-center my-4">
                                                <h6 class="text-dark">Current Total M</h6>
                                                <h6 class="text-dark" id="currentTotalM">{{ $calculate->CurrentM }} MMK</h6>
                                            </div>
                                            ...
                                            <div class=" d-flex justify-content-between align-items-center ">
                                                ...
                                                <h6 class="text-dark" id="morningCost">{{ $calculate->FirstCost }} MMK</h6>
                                            </div>

                                            <div class=" d-flex justify-content-between align-items-center my-4">
                                                <h6 class="text-dark">Evening Cost</h6>
                                                <h6 class="text-dark" id="eveningCost">{{ $calculate->SecondCost }} MMK</h6>
                                            </div>

                                            <div class=" d-flex justify-content-between align-items-center">
                                                <h6 class="text-dark">Total Cost</h6>
                                                <h6 class="text-dark" id="totalCost" >{{ $calculate->TotalFandS }} MMK</h6>
                                            </div>
                                            <hr>

                                            <div class=" d-flex justify-content-between align-items-center my-4">
                                                <h6 class="text-dark">Balance Bills</h6>
                                                <h6 class="text-dark" id="balanceBills" >{{ $calculate->FinalM }} MMK</h6>
                                            </div>
                                        </div>
